...
public class AlipayUtil {
    private static final String AlipayCodePic = "http://whysroom.oss-cn-beijing.aliyuncs.com/yangtzeu/alipay.jpg";
    ...
    static void donateAlipayByPic(final Activity activity) {
        MyUtils.saveFile(activity,AlipayCodePic,"A_Tool/Donate/","支付宝付款码.png");
